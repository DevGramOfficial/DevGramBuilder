...
Команды и общий процесс разработки сделаны привычными для пользователей
ElyxBuilder: `new`, `build`, `watch`, кэш компиляции, ignore-правила и
статистика. Формат пакета при этом нативный для DevGram.
